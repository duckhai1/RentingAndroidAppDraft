...
class Court2Adapter(val arrayList: ArrayList<Model>, val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Court2Adapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: Court2Adapter.ViewHolder, position: Int) {
