...
class Court3Adapter(val arrayList: ArrayList<Model>, val context: Context) :
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener{
        ...
        fun bindItems(model: Model){
            ...
            if (model.slot == 1){
                ...
                itemView.description.setBackgroundColor(Color.parseColor("#ffffff6"))
            }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Court3Adapter.ViewHolder {
        val v = LayoutInflater.from (parent.context).inflate(R.layout.court3_row, parent, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(holder: Court3Adapter.ViewHolder, position: Int) {
